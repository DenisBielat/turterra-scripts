...
.mapboxgl-popup .mapboxgl-popup-content {
  ...
  background: var(--neutral-grays--gray-500) !important;
...
.country-item.selected {
  background-color: var(--alpha-base--20);
}

.mapboxgl-canvas-container .mapboxgl-interactive {
  transition: fill-color 0.3s ease, fill-opacity 0.3s ease;
}

.info-overlay_component-wrapper {
  transition: transform 0.5s cubic-bezier(0.25, 0.1, 0.25, 1);
  transform: translateX(0);
}

.info-overlay_component-wrapper[map-overlay-container="details"] {
  transform: translateX(110%);
}

.info-overlay_component-wrapper.slide-out {
  transform: translateX(110%);
}

.info-overlay_component-wrapper.slide-in {
  transform: translateX(0);
}

.info-overlay_component-wrapper.active {
  transform: translateX(0);
}

.map_info-overlay-container {
  pointer-events: none;
}
